<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String tab_select=request.getParameter("tab_select");
		...
		<div class="row">
			...
			<div class="col-xl-9">
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="tab-pane fade active" role="tabpanel" id="insert">
...
<script>
 $(function(){
	$("document").ready(function(){
		...
		if(tab_select=='delete'){
			alert('삭제 실패!');
		}else if(tab_select=='modify'){
			alert('수정 실패!');
		}else if(tab_select=='search'){
			alert('검색 실패!');
		}
